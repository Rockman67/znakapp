...
mask_path = os.path.join(base_dir,'lama','2','prepare_masks.py')
mask_id_path = os.path.join(base_dir,'lama','2','prepare_masks_id.py')
static_out_dir = os.path.join(base_dir, 'parsers_znakapp','p2', 'images')
txt_out_dir = os.path.join(base_dir, 'parsers_znakapp','p2')
ua = UserAgent()
options = Options()
