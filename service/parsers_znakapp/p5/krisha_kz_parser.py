...
mask_path = os.path.join(base_dir,'lama','5','prepare_masks.py')
mask_id_path = os.path.join(base_dir,'lama','5','prepare_masks_id.py')
static_out_dir = os.path.join(base_dir, 'parsers_znakapp','p5', 'images')
txt_out_dir = os.path.join(base_dir, 'parsers_znakapp','p5')
ua = UserAgent()
options = Options()
